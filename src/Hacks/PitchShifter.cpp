...
void updatePitch() {
...
#ifdef GEODE_IS_IOS
        reinterpret_cast<
            FMOD_RESULT(__cdecl*)(FMOD::ChannelControl*, FMOD::DSP*)>(geode::base::get() + OffsetManager::get()->offsetForFunction(FunctionType::FMOD__ChannelControl__removeDSP))(
            masterGroup,
            pitchDSP
        ); // removeDSP
#else
...
#ifdef GEODE_IS_IOS
    reinterpret_cast<
        FMOD_RESULT(__cdecl*)(FMOD::System*, FMOD_DSP_TYPE, FMOD::DSP**)>(geode::base::get() + OffsetManager::get()->offsetForFunction(FunctionType::FMOD__System__createDSPByType))(
        FMODAudioEngine::sharedEngine()->m_system, FMOD_DSP_TYPE_PITCHSHIFT, &pitchDSP
    ); // createDSPByType
    reinterpret_cast<
        FMOD_RESULT(__cdecl*)(FMOD::ChannelControl*, int, FMOD::DSP*)>(geode::base::get() + OffsetManager::get()->offsetForFunction(FunctionType::FMOD__ChannelControl__addDSP))(
        masterGroup, 0, pitchDSP
    ); // addDSP
#else
    ...
    reinterpret_cast<FMOD_RESULT(__cdecl*)(
        FMOD::DSP*, int, float
    )>(geode::base::get() + OffsetManager::get()->offsetForFunction(FunctionType::FMOD__DSP__setParameterFloat))(
        pitchDSP,

...
#ifdef GEODE_IS_IOS
    reinterpret_cast<FMOD_RESULT(__cdecl*)(FMOD::System*, FMOD_DSP_TYPE, FMOD::DSP**)>(
...
#ifdef GEODE_IS_IOS
    reinterpret_cast<FMOD_RESULT(__cdecl*)(FMOD::DSP*, int, float)>(
...
$execute {
    Loader::get()->queueInMainThread([] {
        ...
        Loader::get()->queueInMainThread([] { updatePitch(); });
    });
}
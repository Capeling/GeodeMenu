...
class $modify(SmartPlayLayer, PlayLayer) {
    ...
    void createObjectsFromSetupFinished() {
        ...
        std::sort(m_fields->speedObjects.begin(), m_fields->speedObjects.end(), [](auto* a, auto* b) {
            return a->getPositionX() < b->getPositionX();
        });
        std::sort(m_fields->mirrorObjects.begin(), m_fields->mirrorObjects.end(), [](auto* a, auto* b) {
            return a->getPositionX() < b->getPositionX();
        });
        std::sort(m_fields->sizeObjects.begin(), m_fields->sizeObjects.end(), [](auto* a, auto* b) {
            return a->getPositionX() < b->getPositionX();
        });
        std::sort(m_fields->dualObjects.begin(), m_fields->dualObjects.end(), [](auto* a, auto* b) {
            return a->getPositionX() < b->getPositionX();
        });
        std::sort(m_fields->gamemodeObjects.begin(), m_fields->gamemodeObjects.end(), [](auto* a, auto* b) {
            return a->getPositionX() < b->getPositionX();
        });
        std::sort(m_fields->gravityObjects.begin(), m_fields->gravityObjects.end(), [](auto* a, auto* b) {
            return a->getPositionX() < b->getPositionX();
        });

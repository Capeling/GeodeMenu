...
#pragma region Setup Windows
    ...
    static void SetupLevel() {
        ...
        level->modules.push_back(
            new Module("Force Platformer", "force-plat", "Force Platformer mode on all levels.\nReopen level to apply."));
        ...
        level->modules.push_back(
            new Module("Quests in Pause", "pause-quests", "Adds a button to open the quests menu in the pause menu", true));
        ...
        level->modules.push_back(
            new Module("Pause Countdown", "pause-countdown", "Shows a countdown for 3 seconds when you unpause a level"));
        level->modules.push_back(new Module("1 Attempt Practice",
                                            "practice-complete",
        ...
        level->modules.push_back(new Module("Legacy Upside Down Physics",
                                            "legacy-upside-down",
        ...
        Client::GetModule("noclip")->options.push_back(new Module(
            "Minimum Accuracy", "noclip-min-accuracy-toggle", "Allows you to die if your noclip accuracy drops below this value"));
        ...
        Client::GetModule("show-layout")
            ->options.push_back(
                new Module("Keep Camera Triggers", "layout-retain-camera", "Keeps the 2.2 camera triggers in the level", true));
    ...
    static void SetupUniversal() {
        ...
        bypass->modules.push_back(
            new Module("Unlock All Icons", "icon-bypass", "It... Unlocks all the icons, You should know what this does"));
        ...
        bypass->modules.push_back(new Module("Comment History Bypass",
                                             "comment-history",
        ...
        bypass->modules.push_back(new Module("Vault Of Secrets Bypass",
    ...
    static void SetupCreator() {
        ...
        creator->modules.push_back(new Module(
            "Smooth Editor Trail", "smooth-editor-trail", "Updates the editor trail at your screen refresh rate instead of 30 fps"));
        ...
        creator->modules.push_back(new Module("Reset Percentage On Save",
...
// cosmetic->modules.push_back(new Module("No Player Rotation", "no-rot", "Disables rotation on players"));
        ...
        cosmetic->modules.push_back(new Module("Percentage Level Font",
    ...
    static void SetupOptions(bool android) {
        ...
        if (true) {
            ...
            cfg->modules.push_back(new Module("Additional Border",
                                              "npesta-width",
